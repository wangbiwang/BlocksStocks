...
function handle_requestsData(type, url, page = 1, perpage = 100) {
    ...
    return {
        ...
        // url: 'https://www.iwencai.com/customized/chart/get-robot-data?iwcpro=1',  //vip URL  起服务使用
        headers: {
            'hexin-v': v(),
            // Cookie: cc + v(), //vip URL  起服务使用
            // 'User-Agent':
            //     'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.3', //vip URL  起服务使用
        },
        data: {
    ...
    !(function () {
        ...
        var qn = (function () {
                ...
                return (
                    ...
                    (l[v(t[80], t[81], b)][ot(i[107])] = function (n) {
                        for (
                            var r = e[8], a = this[ot(e[108], e[109])], o = t[52], u = e[2], s = a[c + r + f];
                            u < s;
                            u++
                        ) {
                            var v = a[u],
        ...
        !(function (n) {
            ...
            function P() {
                ...
                return (
                    (plugin_num = a[52]), navigator[u[201]] && (plugin_num = navigator[p + h + n][c[111]]), plugin_num
                )
            }
        ...
        !(function (n) {
            ...
            function L(n) {
                ...
                return (
                    n +
                    (new t[47](v(r[82], r[221], t[222])).test(n) ? Wn(c[253], i[254], bn) : e[223]) +
                    Yn +
                    c[70] +
                    o[255](a)
                )
