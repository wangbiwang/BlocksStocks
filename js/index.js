...
async function handleStocksData(res, blockItem) {
    ...
    Stocks.Data[0].base = res[0]
        ...
        .map((ele, idx) => {
            ...
            if (条件1) 今日趋势 = 3
            if (条件0 && obj['涨停']) 今日趋势 = 3
            if (条件0 && 资金35 > 资金33 && 大单35 > 大单33 && 涨跌35 > 涨跌33) 今日趋势 = 3
            if (条件0 && [涨跌35, 资金35, 大单35, 涨跌33, 资金33, 大单33].every((x) => x > 0)) 今日趋势 = 3
            if (条件0 && 涨跌35 >= 涨跌33 && 资金35 >= 资金33 && 大单35 >= 大单33) 今日趋势 = 3
            let 条件2 = blockItem['09:35']['资金流向'] < 0 || blockItem['09:35']['大单净额'] < 0
            if (条件2 && 大单35 < 0 && 资金35 < 0) 今日趋势 = 0
            // if (涨跌35 >= 涨跌33 && 资金35 >= 资金33 && 大单35 >= 大单33 && 涨跌35 > 0.5 && 资金35 > 0 && 大单35 > 0) {
            //     今日趋势 = true
            //     昨日趋势 = true
            // }
